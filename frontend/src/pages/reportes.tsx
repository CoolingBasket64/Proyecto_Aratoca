...
export default function Reportes() {
  ...
  const generarExcel = async () => {
    ...
    hoja.columns = [
      ...
      { header: "DIRECCIÓN",                     key: "direccion",                    width: 18 },
      ...
      { header: "SEGUNDO NOMBRE CUIDADOR",    key: "cuidador_segundo_nombre",   width: 29 },
      { header: "PRIMER APELLIDO CUIDADOR",   key: "cuidador_primer_apellido",  width: 29 },
      { header: "SEGUNDO APELLIDO CUIDADOR",  key: "cuidador_segundo_apellido", width: 29 },
      { header: "NOMBRE COMPLETO CUIDADOR",            key: "cuidador_nombre",           width: 36 },
      { header: "DOCUMENTO CUIDADOR",         key: "cuidador_documento",        width: 25 },
      { header: "FECHA NAC CUIDADOR",         key: "cuidador_fecha_nacimiento", width: 25 },
      { header: "EDAD CUIDADOR",              key: "cuidador_edad",             width: 20 },
    ...
    personasFiltradas.forEach((p, i) => {
      ...
      const fila = hoja.addRow({
        ...
        barrio:                    (p.barrio               ?? "").toUpperCase(),
        finca:                    (p.finca            ?? "").toUpperCase(),
